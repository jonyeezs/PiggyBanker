...
describe Budget::Item do
  ...
  it 'should handle debit items' do
    subject = Budget::Item.new description: 'debit item', id: 1,
  ...
  it 'should have defaults' do
    subject = Budget::Item.new occurance: :daily, id: 5
  ...
  it 'should handle display amount for lower occurance' do
    subject = Budget::Item.new description: 'something', id: 3,
  ...
  it 'should handle display amount for an occurance in the middle' do
    subject = Budget::Item.new description: 'jokers to the left..', id: 4,
  ...
  it 'should use == correctly' do
    ...
    test_4 = Budget::Item.new description: 'same same', occurance: :daily,
